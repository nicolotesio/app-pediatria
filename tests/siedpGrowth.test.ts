...
describe("calculateSiedpGrowth", () => {
  ...
  it("interpola i valori LMS quando età non coincide con una riga", () => {
  ...
  it("calcola età decimale da data di nascita e misurazione", () => {
    const age = calculateAgeDecimalFromDates("2020-01-01", "2028-01-01");

    expect(age).toBeCloseTo(8, 2);
  });

  it("calcola l'età decimale come frazione di anno per i calcoli", () => {
  ...
  it("formatta l'età da date in anni e mesi compiuti", () => {
